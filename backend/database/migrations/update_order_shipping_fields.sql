-- 修改订单表：添加shipping_email, shipping_city, shipping_postal_code字段
ALTER TABLE `orders` 
...
-- 默认值可选
-- UPDATE orders SET shipping_email = '', shipping_city = '', shipping_postal_code = '' WHERE shipping_email IS NULL;
