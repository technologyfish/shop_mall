  ...
  <div class="policy-page">
    <div class="policy-container">
      ...
      <div class="policy-content">
        <h2>OVERVIEW</h2>
        <p>Welcome to The Chilli Trail! The terms "we", "us" and "our" refer to The Chilli Trail. The Chilli Trail operates this store and website, including all related information, content, features, tools, products and services in order to provide you, the customer, with a curated shopping experience (the "Services"). The Chilli Trail is powered by Shopify, which enables us to provide the Services to you.</p>
        ...
        <ul>
          ...
          <li>We accept various payment methods, including credit/debit cards and PayPal.</li>
        </ul>

        <h2>Shipping & Returns</h2>
        <ul>
          <li>We aim to dispatch orders within 48 hours on business days.</li>
          <li>Shipping costs are calculated at checkout based on delivery location.</li>
          <li>Returns should be sent to:<br>
            The Chilli Trail<br>
          ...
          <li>Customers are responsible for return shipping unless the item is faulty or incorrect.</li>
        </ul>

        <h2>Intellectual Property</h2>
        <p>All content on our website, including text, images, and logos, is owned by The Chilli Trail and protected by copyright laws.</p>

        <h2>Limitation of Liability</h2>
        <p>We are not liable for any indirect or consequential losses arising from the use of our products.</p>
        ...
        <p>Questions about the Terms of Service should be sent to us at <a href="mailto:contact@thechillitrail.com">contact@thechillitrail.com</a>.</p>
        
        <p>Our contact information is posted below:<br>
          The Chilli Trail Limited<br>
          <a href="mailto:contact@thechillitrail.com">contact@thechillitrail.com</a><br>
          +44 798 569 1869<br>
          16643915
        </p>
      </div>
